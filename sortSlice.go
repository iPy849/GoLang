...
func main() {
	/*
		Solo tengo que decir que hay un paquete "sort" que se encarga de ordenar slices de tipos
		primarios y sé que también se pueden definir funciones que ayuden la organización de tipos
		más complejos
	*/
