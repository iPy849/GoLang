...
func main() {
	/*
		NOTE: Las notas de la sección de orientado a objetos quedan muy bien explicados en los
		recursos de este tweet (https://twitter.com/ipy849/status/1608251013525540864)
	*/
